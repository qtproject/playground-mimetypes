        ...
        while (!reader.atEnd()) {
            ...
            case QXmlStreamReader::StartElement:
                ...
                if (reader.name() == mimeTypeTagC) {
                    ...
                    mimeType.setWeightedGlobPatterns(QMimeTypeData::toGlobPatterns(patterns.split(QLatin1Char(';'))));
        ...
        if (file.open(QFile::WriteOnly | QFile::Truncate)) {
            ...
            foreach (const QMimeType &mimeType, allModifiedMimeTypes) {
                ...
                writer.writeAttribute(QLatin1String(patternAttributeC),
                                      QMimeTypeData::fromGlobPatterns(mimeType.weightedGlobPatterns()).join(QLatin1String(";")));
